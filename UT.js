// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  //if node
var A, ANEW, AP, ASS, AsyncTest, BB, Base, C, Context, DATE, EXPORTED, GG, HM, IS, LL, MAKEa, MAKEs, MAKEt, N, O, ONEW, REMOVE_ME_MS, S, SNEW, Section, SyncTest, TYPE, Test, Type, UT, UTBase, UTRunner, UT_UT, Util, V, VNEW, abort, bag, drill, duck, handler, json, kt, kvt, log, modMap, path, proxyBag, syncTestsCount, target, testList, testStack, textFormat, trace, type, vt,
  indexOf = [].indexOf;
