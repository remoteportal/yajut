// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  // cooked: Sun Sep 16 2018 14:06:50 GMT-0400 (EDT)
  //if node
var A, AsyncTest, Base, Context, EXPORTED, MAKEa, MAKEs, MAKEt, O, REMOVE_ME_MS, S, Section, SyncTest, Test, UT, UTBase, UTRunner, UT_UT, Util, V, bag, handler, log, path, proxyBag, syncTestsCount, target, testList, testStack, trace,
  indexOf = [].indexOf;
...
//		@log "Test constructor: optsOrig", optsOrig
    ...
    if ((ref = this.opts) != null ? ref.tags : void 0) {
      if (!Context.IS.csv(this.opts.tags)) {
