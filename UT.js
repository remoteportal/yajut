// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  //if node
var A, AP, ASS, AsyncTest, BB, Base, C, Context, DATE, EXPORTED, GG, HM, IF, IS, LL, N, O, REMOVE_ME_MS, S, SP, Section, SyncTest, TYPE, Test, Type, UT, UTBase, UTRunner, UT_UT, V, abort, bag, drill, duck, handler, json, kt, kvt, log, modMap, proxyBag, syncTestsCount, target, testList, textFormat, trace, type, vt,
...
//		@lg "Test constructor: optsOrig", optsOrig
    ...
    _ = this.cmd + ' ppaatthh' + this.path; //		_ = "CN=#{@__CLASS_NAME} PATH=[#{@path}]"		#URGENT
