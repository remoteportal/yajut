// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  //if node
var A, AsyncTest, Base, Context, EXPORTED, IS, MAKEa, MAKEs, MAKEt, O, REMOVE_ME_MS, S, Section, SyncTest, Test, UT, UTBase, UTRunner, UT_UT, Util, V, bag, handler, log, path, proxyBag, syncTestsCount, target, testList, testStack, trace,
  indexOf = [].indexOf;
