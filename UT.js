// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  //if node
var ANEW, AP, ASS, AsyncTest, BB, Base, C, Context, DATE, EXPORTED, GG, HM, IF, IS, LL, MAKEa, MAKEs, MAKEt, N, O, ONEW, REMOVE_ME_MS, S, SP, Section, SyncTest, TYPE, Test, Type, UT, UTBase, UTRunner, UT_UT, V, VNEW, abort, bag, drill, duck, handler, json, kt, kvt, log, modMap, path, proxyBag, syncTestsCount, target, testList, testStack, textFormat, trace, type, vt,
  indexOf = [].indexOf;
