...
(function() {
  ...
  //if node
  var A, AP, ASS, AsyncTest, BB, Base, C, Context, DATE, EXPORTED, GG, HM, IF, IS, LL, MAKEa, MAKEs, MAKEt, N, O, REMOVE_ME_MS, S, SP, Section, SyncTest, TYPE, Test, Type, UT, UTBase, UTRunner, UT_UT, V, abort, bag, drill, duck, handler, json, kt, kvt, log, modMap, path, proxyBag, syncTestsCount, target, testList, testStack, textFormat, trace, type, vt,
    indexOf = [].indexOf;
  ...
  UTBase = class UTBase extends Base { //@UTBase
    constructor() {
      ...
      O.MAKE_LG(this, "UTSYS", trace, "UT_RUNNER", () => {
        var ref;
