// coffeeScript.coffee: Generated by CoffeeScript 2.3.1 (coffeescript.coffee IMMED5 affects ./coffee -v)
  ...
  //if node
var A, ANEW, ASS, AsyncTest, BB, Base, C, Context, DATE, EXPORTED, GG, HM, IS, KT, KVT, MAKEa, MAKEs, MAKEt, NNEW, O, ONEW, REMOVE_ME_MS, S, SNEW, Section, SyncTest, Test, UT, UTBase, UTRunner, UT_UT, Util, V, VNEW, VT, bag, drill, duck, handler, json, log, modMap, path, proxyBag, syncTestsCount, target, testList, testStack, textFormat, trace,
  indexOf = [].indexOf;
